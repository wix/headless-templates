...
const features = [
  {
    ...
    description: "Book appointments with just a few clicks, no registration required",
    icon: CalendarClock,
  },
  {
            ...
            <div>
              <AnimatedContainer>
                <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  Seamless Scheduling, <span className="text-primary">Simplified</span>
                </h1>
              </AnimatedContainer>
              
              <AnimatedContainer delay="100">
                <p className="mt-4 text-lg text-muted-foreground">
                  Book appointments with ease, manage your schedule, and never miss an important meeting again.
                </p>
              </AnimatedContainer>
              
              <AnimatedContainer delay="200">
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <Button asChild size="lg" className="rounded-lg px-6 font-medium">
                    <Link to="/schedule">Schedule Now</Link>
                  </Button>
                  <Button variant="outline" size="lg" className="rounded-lg px-6 font-medium">
                    Learn More
                  </Button>
                </div>
              </AnimatedContainer>
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex justify-between items-center pb-4 border-b">
                    ...
                    <div className="flex gap-2">
                      <span className="w-8 h-8 flex items-center justify-center rounded-full bg-secondary">←</span>
                      <span className="w-8 h-8 flex items-center justify-center rounded-full bg-secondary">→</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-7 gap-1 text-center">
                    {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((day) => (
                      <span key={day} className="text-xs font-medium text-muted-foreground p-2">
                        {day}
                      </span>
                    ))}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 bg-secondary/50 rounded-lg">
                      <div className="flex justify-between">
                        <span className="text-xs font-medium">Product Demo</span>
                        <span className="text-xs text-muted-foreground">30 min</span>
                      </div>
                      <div className="text-xs text-muted-foreground mt-1">Nov 23, 11:00 AM</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <AnimatedContainer delay="100">
            <p className="mt-4 text-center text-muted-foreground max-w-2xl mx-auto">
              Our scheduling platform is designed to make booking appointments as simple and efficient as possible.
            </p>
          </AnimatedContainer>
          
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <AnimatedContainer key={feature.title} delay={(index * 100 + 200).toString() as "100" | "200" | "300" | "400" | "500"}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="glass-panel p-8 md:p-12 rounded-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <AnimatedContainer delay="100">
                <p className="mt-4 text-lg text-muted-foreground">
                  Experience the simplicity of our scheduling platform and take control of your calendar.
                </p>
              </AnimatedContainer>
              
              <AnimatedContainer delay="200">
                <Button asChild size="lg" className="mt-8 rounded-lg px-8 font-medium">
