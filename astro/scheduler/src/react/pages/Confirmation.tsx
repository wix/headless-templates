        ...
        <div className="glass-panel p-8 md:p-12 text-center">
          ...
          <AnimatedContainer animation="fade-up" delay="100">
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              Your appointment has been successfully scheduled. We've sent a confirmation email to {bookingData.email}.
            </p>
          </AnimatedContainer>
          ...
          <AnimatedContainer animation="fade-up" delay="200">
            <div className="bg-secondary/40 p-6 rounded-xl mb-8 inline-block mx-auto">
              ...
              <div className="text-left space-y-2">
                <p><span className="text-muted-foreground">Name:</span> {bookingData.name}</p>
                <p><span className="text-muted-foreground">Date:</span> {bookingData.displayDate}</p>
                <p><span className="text-muted-foreground">Time:</span> {bookingData.displayTime}</p>
                <p><span className="text-muted-foreground">Email:</span> {bookingData.email}</p>
                <p><span className="text-muted-foreground">Phone:</span> {bookingData.phone}</p>
                {bookingData.notes && (
                  <p><span className="text-muted-foreground">Notes:</span> {bookingData.notes}</p>
                )}
              </div>
            </div>
          </AnimatedContainer>
