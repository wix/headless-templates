...
(() => {
  // Renamed from '.image-slots.state.json' during the Astro SSR conversion:
  // static asset servers (including @astrojs/node) refuse to serve dotfiles,
  // so the document-relative fetch below 404'd and filled slots were lost.
